...
export function WebGLShader({ timeOffset = 0, speed = 0.01, className }: WebGLShaderProps) {
  ...
  useEffect(() => {
    ...
    const initScene = (): boolean => {
      ...
      // Double-check the context was actually created
      if (!refs.renderer.getContext()) {
        console.warn("WebGL context is null, using CSS fallback")
